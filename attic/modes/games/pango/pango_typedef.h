...
typedef enum
{
    ...
    PA_WSG_PIXEL_ICON,
    PA_WSG_PIPER_SOUTH,
    PA_WSG_PIPER_WALK_SOUTH,
    PA_WSG_PIPER_NORTH,
    PA_WSG_PIPER_WALK_NORTH,
    PA_WSG_PIPER_SIDE,
    PA_WSG_PIPER_WALK_SIDE_1,
    PA_WSG_PIPER_WALK_SIDE_2,
    PA_WSG_PIPER_PUSH_SOUTH_1,
    PA_WSG_PIPER_PUSH_SOUTH_2,
    PA_WSG_PIPER_PUSH_NORTH_1,
    PA_WSG_PIPER_PUSH_NORTH_2,
    PA_WSG_PIPER_PUSH_SIDE_1,
    PA_WSG_PIPER_PUSH_SIDE_2,
    PA_WSG_PIPER_HURT,
    PA_WSG_PIPER_WIN,
    PA_WSG_PIPER_ICON,
    // PA_WSG_BLOCK,
