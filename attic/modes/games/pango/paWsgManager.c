...
void pa_loadWsgs(paWsgManager_t* self)
{
    ...
    loadWsg("pi-000.wsg", &self->wsgs[PA_WSG_PIPER_SOUTH], false);
    loadWsg("pi-001.wsg", &self->wsgs[PA_WSG_PIPER_WALK_SOUTH], false);
    loadWsg("pi-002.wsg", &self->wsgs[PA_WSG_PIPER_NORTH], false);
    loadWsg("pi-003.wsg", &self->wsgs[PA_WSG_PIPER_WALK_NORTH], false);
    loadWsg("pi-004.wsg", &self->wsgs[PA_WSG_PIPER_SIDE], false);
    loadWsg("pi-006.wsg", &self->wsgs[PA_WSG_PIPER_WALK_SIDE_1], false);
    loadWsg("pi-005.wsg", &self->wsgs[PA_WSG_PIPER_WALK_SIDE_2], false);
    loadWsg("pi-007.wsg", &self->wsgs[PA_WSG_PIPER_PUSH_SOUTH_1], false);
    loadWsg("pi-008.wsg", &self->wsgs[PA_WSG_PIPER_PUSH_SOUTH_2], false);
    loadWsg("pi-009.wsg", &self->wsgs[PA_WSG_PIPER_PUSH_NORTH_1], false);
    loadWsg("pi-010.wsg", &self->wsgs[PA_WSG_PIPER_PUSH_NORTH_2], false);
    loadWsg("pi-011.wsg", &self->wsgs[PA_WSG_PIPER_PUSH_SIDE_1], false);
    loadWsg("pi-012.wsg", &self->wsgs[PA_WSG_PIPER_PUSH_SIDE_2], false);
    loadWsg("pi-013.wsg", &self->wsgs[PA_WSG_PIPER_HURT], false);
    loadWsg("pi-014.wsg", &self->wsgs[PA_WSG_PIPER_WIN], false);
    loadWsg("pi-015.wsg", &self->wsgs[PA_WSG_PIPER_ICON], false);
