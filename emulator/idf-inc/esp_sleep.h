...
extern "C"
{
    ...
    typedef enum
    {
        ...
        ESP_PD_OPTION_AUTO //!< Keep power domain enabled in sleep mode, if it is needed by one of the wakeup options.
    ...
    typedef enum
    {
        ...
        ESP_SLEEP_WAKEUP_ALL,             //!< Not a wakeup cause, used to disable all wakeup sources with
