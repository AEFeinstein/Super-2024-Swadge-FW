...
#define USBDC_TESTAMENT_LOC_MASK 0x7FFFF // bits 19-0; this is added to a base address of 0x3FF80000.
    ...
    // The testament is a FIFO. The ROM will output all data between textstart and textend; if textend is lower than
    // textstart it will output everything from textstart to memend, then memstart to textend.
    typedef struct
    {
