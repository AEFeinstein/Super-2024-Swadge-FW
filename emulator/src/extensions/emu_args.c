...
static const char argTomiFile[]    = "tomi-file";
...
static const struct option options[] =
{
    ...
    { argTomiFile,    required_argument, NULL,                             0    },
...
static const optDoc_t argDocs[] =
{
    ...
    { 0,  argTomiFile,    "FILE",  "Load a custom level file into Tomi's Quest, immediately launching into said mode" },
...
static bool handleArgument(const char* optName, const char* arg, int optVal)
{
    ...
    else if (argTomiFile == optName)
    {
        emulatorArgs.tomiFile = arg;
    }
