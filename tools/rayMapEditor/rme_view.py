...
class view:
    ...
    def __init__(self):
        ...
        self.loadTexture(self.texMapPalette, self.texMapMap, tileType.OBJ_ENEMY_START_POINT, '../../assets/ray/OBJ_ENEMY_START_POINT.png')
        self.loadTexture(self.texMapPalette, self.texMapMap, tileType.OBJ_ENEMY_BEAM, '../../assets/ray/OBJ_ENEMY_BEAM.png')
        self.loadTexture(self.texMapPalette, self.texMapMap, tileType.OBJ_ENEMY_CHARGE, '../../assets/ray/OBJ_ENEMY_CHARGE.png')
        self.loadTexture(self.texMapPalette, self.texMapMap, tileType.OBJ_ENEMY_MISSILE, '../../assets/ray/OBJ_ENEMY_MISSILE.png')
        self.loadTexture(self.texMapPalette, self.texMapMap, tileType.OBJ_ENEMY_ICE, '../../assets/ray/OBJ_ENEMY_ICE.png')
        self.loadTexture(self.texMapPalette, self.texMapMap, tileType.OBJ_ENEMY_XRAY, '../../assets/ray/OBJ_ENEMY_XRAY.png')
