...
def main():
    ...
    parser.add_argument(
        "-a",
        "--swadge-assets-path",
        help=f'Path to the Swadge assets directory. The default value is "{defaultAssetsPath}".',
        default=defaultAssetsPath,
    )
    parser.add_argument(
        "-i",
        "--editor-images-path",
        help=f'Path to the Editor images directory. The default value is "{defaultImagesPath}".',
        default=defaultImagesPath,
    )
    parser.add_argument(
        "-f", "--file", help="The map file to load (optional)", default=None
    )
