...
The ESP-IDF Programming Guide also [specifies a udev rule for Linux](https://docs.espressif.com/projects/esp-idf/en/v5.2.6/esp32s2/api-guides/dfu.html#udev-rule-linux-only):
