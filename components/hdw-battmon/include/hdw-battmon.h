 ...
 * href="https://docs.espressif.com/projects/esp-idf/en/v5.1/esp32s2/api-reference/peripherals/adc_oneshot.html">Analog
 * to Digital Converter (ADC) Oneshot Mode Driver</a>.
 *
 * The battery monitor code is based on the <a
 * href="https://github.com/espressif/esp-idf/tree/v5.1/examples/peripherals/adc/oneshot_read">ADC Single Read
 * Example</a>.
 *
