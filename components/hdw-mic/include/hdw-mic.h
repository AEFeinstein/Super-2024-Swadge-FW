 ...
 * href="https://docs.espressif.com/projects/esp-idf/en/v5.3/esp32s2/api-reference/peripherals/adc_continuous.html">Analog
 * to Digital Converter (ADC) Continuous Mode Driver</a>.
 *
 * The microphone code is based on the <a
 * href="https://github.com/espressif/esp-idf/tree/v5.3/examples/peripherals/adc/continuous_read">ADC DMA
 * Example</a>.
 *
