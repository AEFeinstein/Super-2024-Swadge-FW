...
#define EXAMPLE_WAVE_FREQ_HZ        28000                      // Default wave frequency 2000 Hz, it can't be too low
...
#define CONFIG_EXAMPLE_WAVE_PERIOD_MSEC 500
...
static void dac_dma_write_task(void *args)
{
    ...
    while (1) {
        ...
        /* Switch wave every CONFIG_EXAMPLE_WAVE_PERIOD_MSEC milliseconds */
        vTaskDelay(pdMS_TO_TICKS(CONFIG_EXAMPLE_WAVE_PERIOD_MSEC));
        wav_sel++;
