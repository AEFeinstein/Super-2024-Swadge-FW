 ...
 * href="https://docs.espressif.com/projects/esp-idf/en/v5.2.6/esp32s2/api-reference/peripherals/usb_device.html">USB
 * Device Driver</a>. It's based on the <a
 * href="https://github.com/espressif/esp-idf/tree/v5.2.6/examples/peripherals/usb/device/tusb_hid">TinyUSB
