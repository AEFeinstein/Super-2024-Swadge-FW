...
[`esp_err_t esp_now_set_wake_window(uint16_t window)`](https://docs.espressif.com/projects/esp-idf/en/v5.2.8/esp32s2/api-reference/network/esp_now.html#_CPPv423esp_now_set_wake_window8uint16_t)
...
https://docs.espressif.com/projects/esp-idf/en/v5.2.8/esp32s2/api-reference/network/esp_wifi.html#_CPPv448esp_wifi_connectionless_module_set_wake_interval8uint16_t)
...
* [Sleep Modes, Wi-Fi and Sleep Modes](https://docs.espressif.com/projects/esp-idf/en/v5.2.8/esp32s2/api-reference/system/sleep_modes.html#wi-fi-and-sleep-modes)
...
* [Wi-Fi Driver, Connectionless Modules Power-saving](https://docs.espressif.com/projects/esp-idf/en/v5.2.8/esp32s2/api-guides/wifi.html#connectionless-module-power-save)
...
* [ESP-NOW, Config ESP-NOW Power-saving Parameter](https://docs.espressif.com/projects/esp-idf/en/v5.2.8/esp32s2/api-reference/network/esp_now.html#config-esp-now-power-saving-parameter)
...
* [Wi-Fi Driver, ESP32-S2 Wi-Fi Power-saving Mode](https://docs.espressif.com/projects/esp-idf/en/v5.2.8/esp32s2/api-guides/wifi.html#esp32-s2-wi-fi-power-saving-mode)
* [Low Power Mode Usage Guide, Auto Light-sleep + Wi-Fi scenario](https://docs.espressif.com/projects/esp-idf/zh_CN/v5.2.8/esp32s2/api-guides/low-power-mode.html#auto-light-sleep-wi-fi)
