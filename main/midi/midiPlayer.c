                      ...
                      uint32_t* specialStates)
{
    ...
    // Apply channel volume if channel is valid, and if channel volume is not mute or max for micro-optimization to skip division for a vast majority of samples.
