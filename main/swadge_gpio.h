...
typedef enum
{
    ...
    GPIO_TFT_FMARK = GPIO_NUM_14,
    GPIO_BTN_B     = GPIO_NUM_15,
    GPIO_BTN_A     = GPIO_NUM_16,
    GPIO_SAO_A     = GPIO_NUM_17,
    GPIO_SAO_B     = GPIO_NUM_18,
    ...
    GPIO_BZR_1     = GPIO_NUM_40,
    GPIO_I2C_SCL   = GPIO_NUM_41,
    #if defined(CONFIG_HARDWARE_GUNSHIP)
    GPIO_BZR_2 = GPIO_NUM_42,
    #else
    GPIO_BZR_2 = GPIO_NUM_NC, // Not available on CONFIG_HARDWARE_WAVEBIRD
    #endif
    // GPIO_NUM_42 is not connected
    GPIO_TX = GPIO_NUM_43,
    GPIO_RX = GPIO_NUM_44,
    // GPIO_NUM_45 and GPIO_NUM_46 are not connected
    // The following peripherals are not available on this platform
    GPIO_CH32_PROG = GPIO_NUM_NC,
    GPIO_SPK       = GPIO_NUM_NC,
    GPIO_SPK_SHDN  = GPIO_NUM_NC,
    GPIO_TOUCH_6   = GPIO_NUM_NC,
    GPIO_TOUCH_7   = GPIO_NUM_NC,
    GPIO_TOUCH_8   = GPIO_NUM_NC,
    GPIO_TOUCH_9   = GPIO_NUM_NC,
    GPIO_TOUCH_14  = GPIO_NUM_NC,

#elif defined(CONFIG_HARDWARE_HOTDOG_PRODUCTION) || defined(CONFIG_HARDWARE_HOTDOG_PROTO)

    #if defined(CONFIG_HARDWARE_HOTDOG_PROTO)
    GPIO_BTN_LEFT  = GPIO_NUM_0,
    GPIO_BTN_UP    = GPIO_NUM_1,
    GPIO_BTN_RIGHT = GPIO_NUM_2,
    ...
    GPIO_TFT_RESET = GPIO_NUM_38,
    GPIO_LED       = GPIO_NUM_39,
    GPIO_SAO_A     = GPIO_NUM_40,
    GPIO_I2C_SCL   = GPIO_NUM_41,
    GPIO_SAO_B     = GPIO_NUM_42,
    GPIO_TX        = GPIO_NUM_43,
    GPIO_RX        = GPIO_NUM_44,
    // GPIO_NUM_45 and GPIO_NUM_46 are not connected
    ...
    // The following peripherals are not available on this platform
    GPIO_CH32_PROG = GPIO_NUM_NC,
    GPIO_BZR_1     = GPIO_NUM_NC,
    GPIO_BZR_2     = GPIO_NUM_NC,
    GPIO_TOUCH_7   = GPIO_NUM_NC,
    GPIO_TOUCH_8   = GPIO_NUM_NC,
    GPIO_TOUCH_9   = GPIO_NUM_NC,
    GPIO_TOUCH_14  = GPIO_NUM_NC,
