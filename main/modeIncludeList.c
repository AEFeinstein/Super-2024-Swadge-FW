...
swadgeMode_t* const allSwadgeModes[] = {
    &accelTestMode,      &amyTestMode,     &artilleryMode,  &atriumMode,     &bouncyMode,       &canvasTestMode,
    &cipherMode,         &colorchordMode,  &cosCrunchMode,  &danceMode,      &danceNetworkMode, &factoryTestMode,
    &findingFacesMode,   &gamepadMode,     &introMode,      &jukeboxMode,    &keebTestMode,     &mainMenuMode,
...
void modeListSetMenu(menu_t* menu)
{
    ...
    addSingleItemToMenu(menu, amyTestMode.modeName);
