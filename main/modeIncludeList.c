...
swadgeMode_t* const allSwadgeModes[] = {
    &accelTestMode,  &artilleryMode,  &bouncyMode,         &canvasTestMode,   &cipherMode,         &colorchordMode,
    ...
    &swadgeHeroMode, &swadgeItMode,   &swadgePassTestMode, &swadgedokuMode,   &swadgetamatoneMode, &swsnCreatorMode,
