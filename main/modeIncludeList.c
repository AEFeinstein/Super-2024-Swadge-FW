...
swadgeMode_t* const allSwadgeModes[] = {
    ...
    &mainMenuMode,     &modeCredits,     &modeDiceRoller, &modePicross,        &nameTestMode,  &roboRunnerMode,
    &sequencerMode,    &swadgedokuMode,  &swadgeItMode,   &swadgePassTestMode, &synthMode,     &tCaseMode,
