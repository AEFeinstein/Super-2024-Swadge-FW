...
swadgeMode_t* const allSwadgeModes[] = {
    &accelTestMode,   &bouncyMode,    &colorchordMode, &cosCrunchMode,      &danceMode,
    &factoryTestMode, &gamepadMode,   &introMode,      &jukeboxMode,        &keebTestMode,
    &mainMenuMode,    &modeCredits,   &modeDiceRoller, &modePicross,        &nameTestMode,
    &roboRunnerMode,  &sequencerMode, &swadgeItMode,   &swadgePassTestMode, &swadgedokuMode,
