...
swadgeMode_t* const allSwadgeModes[] = {
    ...
    &formulaMagMode,     &gamepadMode,     &introMode,      &jukeboxMode,      &keebTestMode,       &mainMenuMode,
    &modeCh32v003test,   &modeCredits,     &modeDiceRoller, &modePicross,      &modePlatformer,     &nameTestMode,
    &roboRunnerMode,     &sequencerMode,   &sonaTestMode,   &swadgeItMode,     &swadgePassTestMode, &swadgedokuMode,
...
void modeListSetMenu(menu_t* menu)
{
    ...
    addSingleItemToMenu(menu, formulaMagMode.modeName);
