...
swadgeMode_t* const allSwadgeModes[] = {
    &accelTestMode,    &artilleryMode,    &bouncyMode,     &colorchordMode, &cosCrunchMode,      &danceMode,
    ...
    &roboRunnerMode,   &sequencerMode,    &swadgedokuMode, &swadgeItMode,   &swadgePassTestMode, &synthMode,
