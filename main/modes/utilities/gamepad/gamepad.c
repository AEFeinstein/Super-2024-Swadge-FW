        ...
        switch (touchSetting)
            {
                ...
                case GAMEPAD_TOUCH_MORE_BUTTONS_SETTING:
                    ...
                    drawText(&gamepad->ibmFont, c444, "ZL+ZR", tBarX - 19, TFT_HEIGHT / 2 - TOUCHPAD_Y_OFF + Y_OFF - 40);
                    drawText(&gamepad->ibmFont, c444, "ZR", tBarX + 16, TFT_HEIGHT / 2 - TOUCHPAD_Y_OFF + Y_OFF - 24);
                    drawText(&gamepad->ibmFont, c444, "ZL", tBarX - 28, TFT_HEIGHT / 2 - TOUCHPAD_Y_OFF + Y_OFF - 24);
                    ...
                    drawText(&gamepad->ibmFont, c444, "R", tBarX + 20, TFT_HEIGHT / 2 - TOUCHPAD_Y_OFF + Y_OFF + 16);
                    drawText(&gamepad->ibmFont, c444, "L", tBarX - 24, TFT_HEIGHT / 2 - TOUCHPAD_Y_OFF + Y_OFF + 16);
                    drawText(&gamepad->ibmFont, c444, "L+R", tBarX - 10, TFT_HEIGHT / 2 - TOUCHPAD_Y_OFF + Y_OFF + 28);
                    break;
            }
