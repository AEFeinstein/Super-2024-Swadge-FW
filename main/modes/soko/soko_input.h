...
//there is a way to set clever ints here such that we can super quickly convert to dx and dy with bit ops. I'll think it through eventually.
typedef enum
{
    SKD_UP,
    SKD_DOWN,
...
typedef struct
{
    ...
    bool DASActive;///< If DAS has begun. User may be holding before first DAS, this is false. After first, it becomes true.
