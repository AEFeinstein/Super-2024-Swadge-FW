...
void mg_updateLedsLevelSelect(mgEntityManager_t* entityManager)
{
    if(&entityManager->entities[0] == NULL)
    {
        return;
    }
    mgGameData_t* gameData = entityManager->entities[0].gameData;
    for (int32_t i = 0; i < CONFIG_NUM_LEDS; i++)
    {
        gameData->leds[i] = (led_t){.r = 0, .g = 0, .b = 0};
    }
    //I can't get levelsCleared here...
    bool levelAvailable = !(gameData->  platformer->unlockables.levelsCleared & (1 << gameData.level));
    ...
    switch (gameData->level)
    {
        case 1:
        {
            gameData->leds[5] = levelAvailable ? (led_t){.r = 0, .g = 255, .b = 0}
                                               : levelAvailable
                                    ? (led_t){.r = 255, .g = 0, .b = 0};
            break;
        }
        case 2:
        {
            gameData->leds[5] = levelAvailable ? (led_t){.r = 0, .g = 255, .b = 0}
                                               : levelAvailable
                                    ? (led_t){.r = 255, .g = 0, .b = 0};
            gameData->leds[0] = levelAvailable ? (led_t){.r = 0, .g = 255, .b = 0}
                                               : levelAvailable
                                    ? (led_t){.r = 255, .g = 0, .b = 0};
            break;
        }
        ...
        case 4:
        {
            gameData->leds[3] = levelAvailable ? (led_t){.r = 0, .g = 255, .b = 0}
                                               : levelAvailable
                                    ? (led_t){.r = 255, .g = 0, .b = 0};
            break;
        }
        case 5:
        {
            gameData->leds[3] = levelAvailable ? (led_t){.r = 0, .g = 255, .b = 0}
                                               : levelAvailable
                                    ? (led_t){.r = 255, .g = 0, .b = 0};
            gameData->leds[2] = levelAvailable ? (led_t){.r = 0, .g = 255, .b = 0}
                                               : levelAvailable
                                    ? (led_t){.r = 255, .g = 0, .b = 0};
            break;
        }
        ...
        case 7:
        {
            gameData->leds[4] = levelAvailable ? (led_t){.r = 0, .g = 255, .b = 0}
                                               : levelAvailable
                                    ? (led_t){.r = 255, .g = 0, .b = 0};
            break;
        }
        case 8:
        {
            gameData->leds[4] = levelAvailable ? (led_t){.r = 0, .g = 255, .b = 0}
                                               : levelAvailable
                                    ? (led_t){.r = 255, .g = 0, .b = 0};
            gameData->leds[1] = levelAvailable ? (led_t){.r = 0, .g = 255, .b = 0}
                                               : levelAvailable
                                    ? (led_t){.r = 255, .g = 0, .b = 0};
            break;
        }
