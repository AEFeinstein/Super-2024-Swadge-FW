...
const cnfsFileIdx_t MG_BGMS[] = {
    ...
    BGM_SEVER_YATAGA_MID,      BGM_BOSS_SEVER_YATAGA_MID,
    BGM_SMASH_GORILLA_MID,     BGM_BOSS_SMASH_GORILLA_MID,
    BGM_BOSS_TRASH_MAN_MID,    BGM_BIGMA_MID,
    BGM_BOSS_BIGMA_MID,        BGM_LEVEL_CLEAR_JINGLE_MID,
    BGM_POST_FIGHT_MID,        BGM_PRE_FIGHT_MID,
    BGM_INTRO_STAGE_MID,       BGM_STAGE_SELECT_MID,
    BGM_NAME_ENTRY_MID,        MAXIMUM_HYPE_CREDITS_MID,
    BGM_OVO_LIVES_MID,         BGM_THE_GAUNTLET_MID,
    BGM_THE_FINAL_MEGAJAM_MID, BGM_LOOKS_LIKE_WE_MADE_IT_MID,
    BGM_SAWTOOTHS_THEME_MID,   BGM_CLIMAX_MID,
};
