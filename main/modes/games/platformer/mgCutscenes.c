    ...
    switch (gameData->level)
    {
        ...
        case 1: // The Bouncehaus (Kinetic Donut)
        {
            ...
            addCutsceneLine(gameData->cutscene, SawtoothFlipped,
                            " Until Bigma's virus hit. Now no one's ordering anything sane.", false, 2);
            addCutsceneLine(gameData->cutscene, Pulse, "And the RemiX leader here is...?", false, 0);
            addCutsceneLine(
                gameData->cutscene, SawtoothFlipped,
                "Kinetic Donut. King of Queue Chaos. If he's been corrupted, you're in for a very loud fight.", false,
                1);
            addCutsceneLine(gameData->cutscene, Pulse, "Great. I haven't even had lunch.", false, 3);
            break;
        }
        case 6: // The Beat Colosseum (Smash Gorilla)
        {
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "So the party's jumping, but the baddies are ready to rumble?",
                            false, 1);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped, "That's right.", false, 2);
            addCutsceneLine(gameData->cutscene, Pulse, "Or should I say...ready to rumba?", false, 2);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped, "... ...", false, 2);
        ...
        case 7: // The Foundry of Echoes (Deadeye Chirpzi)
        {
            ...
            addCutsceneLine(
                ...
                3);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped,
                            "Be sharp. She's a formidable bounty hunter, likely the best in the galaxy. ", false, 1);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped,
        ...
        case 2: // The Sunshine Speedway (Grind Pangolin)
        {
            ...
            addCutsceneLine(gameData->cutscene, SawtoothFlipped,
                            "Always tricky teleporting onto a moving target. You got your balance?", false, 2);
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Like... a brick wall? Or maybe a sternly worded letter?", false,
                            0);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped, "...A sternly worded letter... Sure. I'm out.", false, 2);
            addCutsceneLine(gameData->cutscene, SystemText, "SAWTOOTH teleports away.", false, 0);
        ...
        case 8: // The Lost Ballroom (Drain Bat)
        {
            addCutsceneLine(
                ...
                0);
            addCutsceneLine(gameData->cutscene, Pulse,
                            "Wait, I thought you said we were heading to the Underground Stage?", false, 0);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped,
                            "Yep. Welcome to the Lost Ballroom. This is where all the really underground acts go.",
                            false, 1);
            addCutsceneLine(gameData->cutscene, Pulse,
                            "Whoa... you really know where all the cool kids hang, huh Sawtooth?", false, 2);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped,
                            "Cool, cursed, corrupted-take your pick. Just watch your head...", false, 3);
        ...
        case 3: // The Twin Peaks (Sever Yataga)
        {
            ...
            addCutsceneLine(gameData->cutscene, SawtoothFlipped,
                            ...
                            "sacred dance space...",
                            false, 3);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped, "Now it's Sever Yataga's turf.", false, 1);
            addCutsceneLine(gameData->cutscene, Pulse, "\"Yataga\"? What's that?", false, 0);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped,
                            "Short for Yatagarasu-a mythical three-legged crow in Shinto lore. A divine guide. It's "
                            "said to lead people through darkness.",
                            false, 3);
            addCutsceneLine(gameData->cutscene, Pulse,
                            "So why does THIS Yataga sound like a boss fight with a cover charge?", false, 0);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped,
            ...
            addCutsceneLine(gameData->cutscene, SawtoothFlipped,
                            ...
                            false, 0);
            addCutsceneLine(gameData->cutscene, Pulse, "Corrupting a guiding god into a rave god...", false, 0);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped,
                            "Isolation in the name of freedom. A twisted remix of what they stood for.", false, 2);
        ...
        case 9: // Arena Hypernova (Flare Gryffyn and Jolt Lapin and Crash Turtle)
        {
            ...
            addCutsceneLine(gameData->cutscene, SystemText,
                            ...
                            "is not there.",
                            false, 0);
            addCutsceneLine(gameData->cutscene, Pulse, "... SAWTOOTH?", false, 0);
            addCutsceneLine(gameData->cutscene, Pulse, "SAWTOOTH, come in! Are you there?", false, 4);
        ...
        case 4: // The Recycled Pit in the Inferno Arena (Trash Man fake our for Ember)
        {
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Ughh... what's that awful smell?", false, 4);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped, "Check your coordinates. Something's not right.",
                            false, 1);
            addCutsceneLine(gameData->cutscene, Pulse,
                            "It says this is the right place... but it looks like a landfill.", false, 0);
            addCutsceneLine(
                gameData->cutscene, SawtoothFlipped,
        ...
        case 5: // The Overture Terminal (gauntlet)
        {
            ...
            addCutsceneLine(gameData->cutscene, SawtoothPostRevealFlipped,
                            "Don't listen to him. He's trying to get in your head.", false, 3);
            addCutsceneLine(
            ...
            addCutsceneLine(gameData->cutscene, Bigma,
                            ...
                            false, 1);
            addCutsceneLine(gameData->cutscene, Bigma, "Let's see if you can hit every note.", false, 0);
        ...
        case 11: // Bigma Stage 2 (BOSS RUSH)
        {
            ...
            addCutsceneLine(gameData->cutscene, Bigma,
                            ...
                            false, 1);
            addCutsceneLine(gameData->cutscene, Pulse, "Come out and fight me already!", false, 4);
            break;
        }
        default: // Hank Final Battle
        {
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Do you recognize that voice?", false, 0);
            addCutsceneLine(gameData->cutscene, QuestionMark, "I wasn't talking to you, kid. I was talking to her.", false, -1);
            addCutsceneLine(gameData->cutscene, QuestionMark, "Isn't that right...Deadeye?", false, -1);
            addCutsceneLine(gameData->cutscene, SystemText, "The other RemiXes are all revealed in the shadows, in chains. A spotlight falls on DEADEYE CHIRPZI.", false, -1);
            ...
            addCutsceneLine(gameData->cutscene, DeadeyeChirpziUncorrupted, "... No. It can't be. Is that-", true, -1);
...
void bossIntroCutscene(mgGameData_t* gameData)
{
    ...
    switch (gameData->level)
    {
        case 10: // Intro Stage
        {
            ...
            addCutsceneLine(gameData->cutscene, Bigma, "Still barking orders, I see. Some things never change.", false, 0);
        ...
        case 1: // The Bouncehaus (Kinetic Donut)
        {
            addCutsceneLine(gameData->cutscene, Pulse, "You there! Step away from the deep fryer!!", false, 4);
            addCutsceneLine(gameData->cutscene, KineticDonut, "Oooooh-did my tacos get here early?! Love when that happens!", false, -1);
            addCutsceneLine(gameData->cutscene, Pulse, "I'm not your delivery driver!", false, 3);
            addCutsceneLine(gameData->cutscene, Pulse, "Though I AM about to serve you a beatdown.", false, 1);
        ...
        case 6: // The Beat Colosseum (Smash Gorilla)
        {
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Hey! I know enough to know that was rude.", false, 3);
            addCutsceneLine(gameData->cutscene, Pulse, "Are you asking for a challenge?", false, 1);
            addCutsceneLine(gameData->cutscene, SmashGorilla, "Dejalo caer como si estuviera caliente, tonto.", false, -1);
            addCutsceneLine(gameData->cutscene, Pulse, "Oh it's ON!", false, 2);
            break;
        }
        case 7: // The Foundry of Echoes (Deadeye Chirpzi)
        {
            addCutsceneLine(gameData->cutscene, Pulse, "Hello...?", false, 4);
            addCutsceneLine(gameData->cutscene, SystemText, "A sudden sniper shot blast cracks the floor at PULSE's feet.", false, 0);
            addCutsceneLine(gameData->cutscene, Pulse, "WOAH! That was close! Good thing that system text gave me a warning!", false, 0);
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Two on one? That's low-even for a bounty hunter.", false, 3);
        ...
        case 2: // The Sunshine Speedway (Grind Pangolin)
        {
            addCutsceneLine(gameData->cutscene, Pulse, "Hold it, rude boy! This ride's over!", false, 4);
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Uh-no, I was-wait, how did you...?", false, 0);
        ...
        case 8: // The Lost Ballroom (Drain Bat)
        {
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Battrice? You don't belong in this world!", false, 4);
            addCutsceneLine(gameData->cutscene, DrainBat, "It was not by my hand that I was once again-", false, -1);
            addCutsceneLine(gameData->cutscene, Pulse, "Okay. Yeah, Gonna stop you right there.. It was BIGMA. Mind control. Virus. You've been corrupted.", false, 2);
            addCutsceneLine(gameData->cutscene, DrainBat, "... I was brought here by-what? I had a whole monologue...", false, -1);
            addCutsceneLine(gameData->cutscene, Pulse, "Do it later. Right now it's just me and you.", false, 1);
            addCutsceneLine(gameData->cutscene, DrainBat, "...Fine. Enough talk-have at you!", false, -1);
            addCutsceneLine(gameData->cutscene, Pulse, "Gesundheit!", false, 2);
            break;
        }
        case 3: // The Twin Peaks (Sever Yataga)
        {
            addCutsceneLine(gameData->cutscene, SeverYataga, "LEAVE. US. ALONE.", false, -1);
            addCutsceneLine(gameData->cutscene, Pulse, "Yataga-san! It's me-Pulse! We need you back in the fight for Omega Harbor!", false, 4);
            addCutsceneLine(gameData->cutscene, SeverYataga, "WE OWE NOTHING TO THE WORLD THAT BROKE US. THIS IS OUR HAVEN. OUR RAVE. OUR RULES.", false, -1);
            addCutsceneLine(gameData->cutscene, Pulse, "That sounds... honestly exhausting. No naps? No snacks?", false, 0);
            addCutsceneLine(gameData->cutscene, SeverYataga, "WE ARE THE SKY'S LAST SCREAM. CHALLENGE US... AND PREPARE TO BE SILENCED.", false, -1);
            addCutsceneLine(gameData->cutscene, Pulse, "Okay, okay! Just asking nicely first! Guess we're doing this!", false, 3);
            break;
        }
        case 9: // Arena Hypernova (Flare Gryffyn and Jolt Lapin and Crash Turtle)
        {
            addCutsceneLine(gameData->cutscene, SawtoothFlipped, "PULSE! I told you to back off!", false, 1);
            ...
            addCutsceneLine(gameData->cutscene, SawtoothFlipped, "This is personal. Stay back, or I shoot.", false, 1);
            addCutsceneLine(gameData->cutscene, Pulse, "...", false, 0);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped, "...Just.... Give me a minute first.", false, 0);
            addCutsceneLine(gameData->cutscene, Pulse, "...", false, 0);
            addCutsceneLine(gameData->cutscene, SystemText, "SAWTOOTH enters the boss room alone. From the next room, the sounds of battle can be heard-explosions, energy discharges.", false, 0);
            addCutsceneLine(gameData->cutscene, Pulse, "... Okay that's long enough. I'm going in.", false, 1);
            addCutsceneLine(gameData->cutscene, Pulse, "SAWTOOTH! Where are you?", false, 4);
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "What did you do to her?!", false, 4);
        ...
        case 4: // The Recycled Pit in the Inferno Arena (Trash Man fake our for Ember)
        {
            addCutsceneLine(gameData->cutscene, Pulse, "RIP BARONESS! ... Why are you in a cage?!", false, 4);
            addCutsceneLine(gameData->cutscene, Ember, "It's just Ember, actually. \"Baroness\" was a phase.", false, -1);
            addCutsceneLine(gameData->cutscene, Pulse, "So... you're not corrupted?", false, 0);
            addCutsceneLine(gameData->cutscene, Ember, "Nah. I'm a demon. I'm already corrupt. That's kinda the brand.", false, -1);
            addCutsceneLine(gameData->cutscene, Pulse, "...Then why are you-", false, 0);
            ...
            addCutsceneLine(gameData->cutscene, TrashMan, "IT IS I -DR. GARBOTNIK. THE TRASH MAN!", false, 1);
            addCutsceneLine(gameData->cutscene, Pulse, "Who?", false, 0);
            addCutsceneLine(gameData->cutscene, TrashMan, "THE TRASH MAN!", false, 0);
            addCutsceneLine(gameData->cutscene, Ember, "Yeah, this is on me. Sorry.", false, -1);
            addCutsceneLine(gameData->cutscene, Pulse, "Is this why it smells like melted hamsters and regret?", false, 3);
            ...
            addCutsceneLine(gameData->cutscene, TrashMan, "...Now dig on this.", false, 0);
            addCutsceneLine(gameData->cutscene, Ember, "Aaaaand there it is.", false, -1);
            break;
        }
        case 5: // The Overture Terminal (gauntlet)
        {
            addCutsceneLine(gameData->cutscene, Pulse, "Whew, I can't believe we made it.", false, 3);
            addCutsceneLine(gameData->cutscene, SawtoothPostRevealFlipped, "Don't let your guard down now, PULSE!", false, 1);
            addCutsceneLine(gameData->cutscene, Pulse, "Where has BIGMA gone?", false, 0);
            addCutsceneLine(gameData->cutscene, SawtoothPostRevealFlipped, "Hmm, that mixtape must be some kind of trap.", false, 3);
            addCutsceneLine(gameData->cutscene, Pulse, "After getting through this terminal, we can conquer ANYTHING he throws at us!", false, 2);
            break;
        }    
        case 11: // Bigma stage 2 (BOSS RUSH)
        {
            ...
            addCutsceneLine(gameData->cutscene, SawtoothPostReveal,
                            ...
                            false, 3);
            addCutsceneLine(gameData->cutscene, Bigma,
                            "MAGiX backups. Constructed from your past encounters, and turned against you.", false, 0);
            addCutsceneLine(gameData->cutscene, Bigma,
                            "Every fight, every tactic-you taught me how to defeat you, PULSE. Time to see if you've "
                            "learned anything new.",
                            false, 1);
            addCutsceneLine(gameData->cutscene, Pulse, "UGH. A boss rush? Why is it always a boss rush?!", false, 3);
            addCutsceneLine(gameData->cutscene, SawtoothPostReveal,
        ...
        default: // Hank Final Battle
        {
            ...
            addCutsceneLine(gameData->cutscene, SawtoothPostRevealFlipped, "Okay-what?! Cho, you seriously need to explain what's happening.", false, 3);
            ...
            addCutsceneLine(gameData->cutscene, SawtoothPostRevealFlipped, "Cho...?", false, 3);
...
void bossOutroCutscene(mgGameData_t* gameData)
{
    ...
    switch (gameData->level)
    {
        case 10: // Intro Stage
        {
            ...
            addCutsceneLine(gameData->cutscene, Bigma, "Hmmm... A fresh start sounds nice...", false, 2);
            addCutsceneLine(gameData->cutscene, SystemText, "PULSE and BIGMA shake hands.", false, 0);
            addCutsceneLine(gameData->cutscene, Bigma, "... but I work solo.", false, 3);
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Aghh! What... was that?!", false, 4);
            ...
            addCutsceneLine(gameData->cutscene, SawtoothFlipped, "Dont worry, while you two were fighting, I was remotely hacking Bigma's systems to get his encryption key.", false, 2);
            break;
        }
        case 1: // The Bouncehaus (Kinetic Donut)
        {
            ...
            else
            {
                ...
                addCutsceneLine(gameData->cutscene, Pulse, "I get that way too sometimes.", false, 2);
                ...
                addCutsceneLine(gameData->cutscene, AbilityUnlocked, "........................................................... Press down and A in the air.", false, 0);
                addCutsceneLine(gameData->cutscene, AbilityUnlocked, "........................................................... Unleash a ground-pound sound attack with a mic drop!", false, 0);
                addCutsceneLine(gameData->cutscene, Pulse, "You going to be okay, Your Majesty?", false, 2);
        ...
        case 6: // The Beat Colosseum (Smash Gorilla)
        {
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "The whole place was vibing TOO hard. You back to normal?", false, 2);
        ...
        case 7: // The Foundry of Echoes (Deadeye Chirpzi)
        {
            addCutsceneLine(gameData->cutscene, DeadeyeChirpziUncorrupted, "Urgghh... My head....I haven't blacked out like that since the afterparty in 2024...", false, -1);
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Is he... talking to you?", false, 0);
        ...
        case 8: // The Lost Ballroom (Drain Bat)
        {
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Yeah, uh... where is that exactly?", false, 0);
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "... Sure.", false, 0);
        ...
        case 3: // The Twin Peaks (Sever Yataga)
        {
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Happy to have you both back.", false, 2);
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "This feels... solid. But also, weirdly... ironic?", false, 2);
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Wait-so am I the main character?", false, 0);
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "... Okay. But, thanks.", false, 2);
            addCutsceneLine(gameData->cutscene, Pulse, "Wait... Are you Japanese, Jasper?", false, 0);
            addCutsceneLine(gameData->cutscene, Jasper, "Nah, I'm from Queens. I'm just a big ol' weeb.", false, -1);
            addCutsceneLine(gameData->cutscene, Pulse, "Noted. See ya!", false, 2);
            break;
        }
        case 9: // Arena Hypernova (Flare Gryffyn and Jolt Lapin and Crash Turtle)
        {
            ...
            addCutsceneLine(gameData->cutscene, SawtoothFlipped, "That oughta shut him up for a while.", false, 2);
            addCutsceneLine(gameData->cutscene, Pulse, "SAWTOOTH! You're OKAY! What happened?!", false, 2);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped, "Sigh... It was a lot, seeing these guys again.", false, 0);
            addCutsceneLine(gameData->cutscene, Pulse, "Okay, you have to tell me... What is going on here?! What is your history with the Suncats?", false, 0);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped, "...", false, 0);
            addCutsceneLine(gameData->cutscene, Pulse, "...", false, 0);
            addCutsceneLine(gameData->cutscene, SawtoothFlipped, "Well... we've come this far. Might as well come clean.", false, 0);
            addCutsceneLine(gameData->cutscene, Pulse, "...", false, 0);
            addCutsceneLine(gameData->cutscene, SunnyFlipped, "...I was their leader once.", false, 0);
            addCutsceneLine(gameData->cutscene, Pulse, "You're... SUNNY?! Sunny McShreds of the Suncats?!! You've been hiding your identity the whole time?", false, 0);
            addCutsceneLine(gameData->cutscene, SunnyFlipped, "I... had a falling out with the rest of the team a few years back. We lost touch. Life happened.", false, 0);
            addCutsceneLine(gameData->cutscene, SunnyFlipped, "I was going to call them, but then BIGMA started targeting all the RemiXes... I thought it was best if I stayed hidden.", false, 0);
            ...
            addCutsceneLine(gameData->cutscene, SystemText, "Sunny puts her helmet back on.", false, 0);
            addCutsceneLine(gameData->cutscene, SawtoothPostRevealFlipped, "...", false, 1);
            addCutsceneLine(gameData->cutscene, Pulse, "...Will they be OK?", false, 0);
            addCutsceneLine(gameData->cutscene, SawtoothPostRevealFlipped, "...I honestly don't know. I hope so. But they're knocked out pretty hard.", false, 0);
            addCutsceneLine(gameData->cutscene, Pulse, "...", false, 0);
            addCutsceneLine(gameData->cutscene, SawtoothPostRevealFlipped, "Here. Take Gryffyn's Reflector Shield. You can use it to bounce back energy-based attacks.", false, 2);
            addCutsceneLine(gameData->cutscene, SawtoothPostRevealFlipped, "Might give you an edge against BIGMA's flashier tricks.", false, 2);
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Are you sure Gryffyn won't mind?", false, 0);
            addCutsceneLine(gameData->cutscene, SawtoothPostRevealFlipped, "Once we put a stop to BIGMA, I'm sure he'll forgive you.", false, 1);
            break;
        }
        case 4: // The Recycled Pit in the Inferno Arena (Trash Man fake our for Ember)
        {
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Tell me about it.", false, 3);
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Do you want to, like, repay me with a power-up or something?", false, 0);
        ...
        case 11: // Bigma stage 2 (BOSS RUSH)
        {
            ...
            addCutsceneLine(gameData->cutscene, Bigma, "ROOOOOAAAAARR... WHY won't you JUST QUIT?", false, 2);

            addCutsceneLine(gameData->cutscene, Pulse, "You've made us fight through so much... But I still don't get it. Why? You've changed so much...", false, 0);
            addCutsceneLine(gameData->cutscene, Bigma, "No, YOU'RE the ones who've changed!", false, 1);
            addCutsceneLine(gameData->cutscene, SawtoothPostReveal, "What?", false, 3);
            ...
            addCutsceneLine(gameData->cutscene, Bigma, "Urggghhhh....", false, 2);
            addCutsceneLine(gameData->cutscene, SawtoothPostReveal, "I miss the old days too sometimes...", false, 2);
            addCutsceneLine(gameData->cutscene, Pulse, "I think we all do.", false, 1);
            addCutsceneLine(gameData->cutscene, SawtoothPostReveal, "But we can't live in the past forever... We evolve. We grow. For the next generation.", false, 3);
            addCutsceneLine(gameData->cutscene, Bigma, "...", false, 2);
            addCutsceneLine(gameData->cutscene, Pulse, "For the next generation...?", false, 2);
        ...
        default: // Hank Final Battle
        {
            ...
            addCutsceneLine(gameData->cutscene, Percy, "Or light new ones.", true, -1);
            ...
            addCutsceneLine(gameData->cutscene, Bigma, "You think we're copies, but that's not the point. We're all echoes of what came before.", true, 2);
            addCutsceneLine(gameData->cutscene, HankWaddle, "What do you mean?", false, 1);
            addCutsceneLine(gameData->cutscene, SawtoothPostReveal, "The ones who inspired us - they were just riffing on the stuff they liked, too.", false, 3);
            ...
            addCutsceneLine(gameData->cutscene, SawtoothFlipped, "EVERYBODY! We have to get out of here!", false, 3);
            ...
            addCutsceneLine(gameData->cutscene, Pulse, "Sunny... was he right about us?", true, 0);
            addCutsceneLine(gameData->cutscene, Sunny, "I... don't know.", false, 0);
            addCutsceneLine(gameData->cutscene, Bigma, "Maybe you'll find out someday. But until then...", false, 2);
