...
void loadEnvTextures(ray_t* ray)
{
    ...
    // LOAD_TEXTURE(ray, OBJ_ENEMY_0);
    // LOAD_TEXTURE(ray, OBJ_ENEMY_1);
    loadTexture(ray, BLOCK_WSG, OBJ_ENEMY_BOX);
    LOAD_TEXTURE(ray, OBJ_ENEMY_2);
    LOAD_TEXTURE(ray, OBJ_ENEMY_3);
    LOAD_TEXTURE(ray, OBJ_ENEMY_4);
    LOAD_TEXTURE(ray, OBJ_ENEMY_5);
    LOAD_TEXTURE(ray, OBJ_ENEMY_6);
    LOAD_TEXTURE(ray, OBJ_ENEMY_7);
    LOAD_TEXTURE(ray, OBJ_ENEMY_8);
    LOAD_TEXTURE(ray, OBJ_ENEMY_9);
    LOAD_TEXTURE(ray, OBJ_ENEMY_10);
    LOAD_TEXTURE(ray, OBJ_ENEMY_11);
    LOAD_TEXTURE(ray, OBJ_ENEMY_12);
    LOAD_TEXTURE(ray, OBJ_ENEMY_13);
    LOAD_TEXTURE(ray, OBJ_ENEMY_14);
    LOAD_TEXTURE(ray, OBJ_ENEMY_15);
    LOAD_TEXTURE(ray, OBJ_ENEMY_16);
    LOAD_TEXTURE(ray, OBJ_ENEMY_17);
    LOAD_TEXTURE(ray, OBJ_ENEMY_18);
    LOAD_TEXTURE(ray, OBJ_ENEMY_19);
    LOAD_TEXTURE(ray, OBJ_ENEMY_20);
    LOAD_TEXTURE(ray, OBJ_ENEMY_21);
    LOAD_TEXTURE(ray, OBJ_ENEMY_22);
    LOAD_TEXTURE(ray, OBJ_ENEMY_23);
    LOAD_TEXTURE(ray, OBJ_ENEMY_24);
    LOAD_TEXTURE(ray, OBJ_ENEMY_25);
    LOAD_TEXTURE(ray, OBJ_ENEMY_26);
    LOAD_TEXTURE(ray, OBJ_ENEMY_27);
    LOAD_TEXTURE(ray, OBJ_ENEMY_28);
    LOAD_TEXTURE(ray, OBJ_ENEMY_29);
    LOAD_TEXTURE(ray, OBJ_ENEMY_30);
    LOAD_TEXTURE(ray, OBJ_ENEMY_31);
    LOAD_TEXTURE(ray, OBJ_ITEM_0);
    LOAD_TEXTURE(ray, OBJ_ITEM_1);
    LOAD_TEXTURE(ray, OBJ_ITEM_2);
    LOAD_TEXTURE(ray, OBJ_ITEM_3);
    LOAD_TEXTURE(ray, OBJ_ITEM_4);
    LOAD_TEXTURE(ray, OBJ_ITEM_5);
    LOAD_TEXTURE(ray, OBJ_ITEM_6);
    LOAD_TEXTURE(ray, OBJ_ITEM_7);
    LOAD_TEXTURE(ray, OBJ_ITEM_8);
    LOAD_TEXTURE(ray, OBJ_ITEM_9);
    LOAD_TEXTURE(ray, OBJ_ITEM_10);
    LOAD_TEXTURE(ray, OBJ_ITEM_11);
    LOAD_TEXTURE(ray, OBJ_ITEM_12);
    ...
    LOAD_TEXTURE(ray, OBJ_SCENERY_0);
