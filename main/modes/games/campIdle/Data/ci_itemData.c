...
int ci_getArrayLength(ci_itemTypes_t type)
{
    switch (type)  
    {
        case CI_BAD_FOOD:
        {
            return ARRAY_SIZE(ci_badFoodData);
        }
        case CI_CRAFTED:
        {
            return ARRAY_SIZE(ci_craftedData);
        }
        case CI_FOOD:
        {
            return ARRAY_SIZE(ci_foodData);
        }
        case CI_FORAGED:
        {
            return ARRAY_SIZE(ci_foragedData);
        }
        case CI_HEALING:
        {
            return ARRAY_SIZE(ci_healingData);
        }
        case CI_TYPE_ALL:
        default:
        {
            return ARRAY_SIZE(ci_badFoodData) + ARRAY_SIZE(ci_craftedData) + ARRAY_SIZE(ci_foodData)
