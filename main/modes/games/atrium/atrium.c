        ...
        if (evt->down)
        {
            ...
            if (evt->button & PB_A)
            {
                if (atr->yloc == 4) // save profile
                {
                    ...
                    writeNamespaceNvs32(ATRIUM_PROFILE_NVS_NAMESPACE, ATRIUM_PACKEDKEY, atr->loadedProfile.packedProfile);
                    ...
                    ESP_LOGI(ATR_TAG,
                             "swadgepass profile saved: packedProfile %" PRId32 ", numPasses %" PRId8 ", points %" PRId32 "",
