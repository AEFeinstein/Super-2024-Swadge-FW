...
// Prototypes
//==============================================================================
void bb_addToHeap(bb_heap_t* heap, const bb_heapItem_t* item);
...
void bb_sortUp(bb_heap_t* heap, const bb_heapItem_t* item);
void bb_swap(bb_heap_t* heap, const bb_heapItem_t* itemA, const bb_heapItem_t* itemB);
