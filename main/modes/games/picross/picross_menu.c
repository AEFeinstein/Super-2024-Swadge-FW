...
struct
{
    ...
    {.name = "arrow", .pzl = _55_ARROW_PZL_WSG, .slv = _55_ARROW_SLV_WSG, .marqueeFact = "An arrow pointing up, blah blah blah."},
    {.name = "check", .pzl = _55_CHECK_PZL_WSG, .slv = _55_CHECK_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "crown", .pzl = _55_CROWN_PZL_WSG, .slv = _55_CROWN_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "flower", .pzl = _55_FLOWER_PZL_WSG, .slv = _55_FLOWER_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "ghost", .pzl = _55_GHOST_PZL_WSG, .slv = _55_GHOST_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "heart", .pzl = _55_HEART_PZL_WSG, .slv = _55_HEART_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "kitty", .pzl = _55_KITTY_PZL_WSG, .slv = _55_KITTY_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "pacman", .pzl = _55_PACMAN_PZL_WSG, .slv = _55_PACMAN_SLV_WSG, .marqueeFact = "wakka wakka wakka"},
    {.name = "rainbow", .pzl = _55_RAINBOW_PZL_WSG, .slv = _55_RAINBOW_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "triangle", .pzl = _55_TRIANGLE_PZL_WSG, .slv = _55_TRIANGLE_SLV_WSG, .marqueeFact = "Congratulations! You found the triangle!"},
    {.name = "mag1", .pzl = _6F_MAG_1_PZL_WSG, .slv = _6F_MAG_1_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "mag2", .pzl = _6F_MAG_2_PZL_WSG, .slv = _6F_MAG_2_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "mag3", .pzl = _6F_MAG_3_PZL_WSG, .slv = _6F_MAG_3_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "maglogo", .pzl = _6F_MAGLOGO_PZL_WSG, .slv = _6F_MAGLOGO_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "music", .pzl = _6F_MUSIC_PZL_WSG, .slv = _6F_MUSIC_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "flyindonut", .pzl = _8F_FLYINDONUT_PZL_WSG, .slv = _8F_FLYINDONUT_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "mtype", .pzl = _8F_MTYPE_PZL_WSG, .slv = _8F_MTYPE_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "personaldemon", .pzl = _8F_PERSONALDEMON_PZL_WSG, .slv = _8F_PERSONALDEMON_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "shredder", .pzl = _8F_SHREDDER_PZL_WSG, .slv = _8F_SHREDDER_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "stomp", .pzl = _8F_STOMP_PZL_WSG, .slv = _8F_STOMP_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "apple", .pzl = AA_APPLE_PZL_WSG, .slv = AA_APPLE_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "baba", .pzl = AA_BABA_PZL_WSG, .slv = AA_BABA_SLV_WSG, .marqueeFact = "BABA is NONOGRAM. NONOGRAM is WIN."},
    {.name = "dragonball", .pzl = AA_DRAGONBALL_PZL_WSG, .slv = AA_DRAGONBALL_SLV_WSG, .marqueeFact = "If your head is empty, you can pack it with dreams!"},
    {.name = "heartpiece", .pzl = AA_HEARTPIECE_PZL_WSG, .slv = AA_HEARTPIECE_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "metroid", .pzl = AA_METROID_PZL_WSG, .slv = AA_METROID_SLV_WSG, .marqueeFact = "jellyfish is helping yes.      Y can't metroid crawl?"},
    {.name = "moonstick", .pzl = AA_MOONSTICK_PZL_WSG, .slv = AA_MOONSTICK_SLV_WSG, .marqueeFact = "Moon Healing Escalation!"},
    {.name = "peach", .pzl = AA_PEACH_PZL_WSG, .slv = AA_PEACH_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "pokeball", .pzl = AA_POKEBALL_PZL_WSG, .slv = AA_POKEBALL_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "sword", .pzl = AA_SWORD_PZL_WSG, .slv = AA_SWORD_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "toadstool", .pzl = AA_TOADSTOOL_PZL_WSG, .slv = AA_TOADSTOOL_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "donutjump", .pzl = AF_DONUTJUMP_PZL_WSG, .slv = AF_DONUTJUMP_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "picross", .pzl = AF_PICROSS_PZL_WSG, .slv = AF_PICROSS_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "superswadgeland", .pzl = AF_SUPERSWADGELAND_PZL_WSG, .slv = AF_SUPERSWADGELAND_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "swadgebros", .pzl = AF_SWADGEBROS_PZL_WSG, .slv = AF_SWADGEBROS_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "tiltrads", .pzl = AF_TILTRADS_PZL_WSG, .slv = AF_TILTRADS_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "galacticbrickdown", .pzl = CF_GALACTICBRICKDOWN_PZL_WSG, .slv = CF_GALACTICBRICKDOWN_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "lumberjacks", .pzl = CF_LUMBERJACKS_PZL_WSG, .slv = CF_LUMBERJACKS_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "magtroidpocket", .pzl = CF_MAGTROIDPOCKET_PZL_WSG, .slv = CF_MAGTROIDPOCKET_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "pushykawaiigo", .pzl = CF_PUSHYKAWAIIGO_PZL_WSG, .slv = CF_PUSHYKAWAIIGO_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    ...
    {.name = "2048", .pzl = EF_2048_PZL_WSG, .slv = EF_2048_SLV_WSG, .marqueeFact = "Did you know? 2048 is so named because that’s The highest value, the dev was able to get to before he started to cry !"},
    {.name = "chowagrove", .pzl = EF_CHOWAGROVE_PZL_WSG, .slv = EF_CHOWAGROVE_SLV_WSG, .marqueeFact = "Did you know? Chowa Grove was going to have multiple Chowa types but the dev got too lazy"},
    {.name = "hunterspuzzles", .pzl = EF_HUNTERSPUZZLES_PZL_WSG, .slv = EF_HUNTERSPUZZLES_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "swadgehero", .pzl = EF_SWADGEHERO_PZL_WSG, .slv = EF_SWADGEHERO_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "ultimatettt", .pzl = EF_ULTIMATETTT_PZL_WSG, .slv = EF_ULTIMATETTT_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "acleaf", .pzl = FF_ACLEAF_PZL_WSG, .slv = FF_ACLEAF_SLV_WSG, .marqueeFact = "The ultimate flat-pack furniture. IKEA could never."},
    {.name = "doublebass", .pzl = FF_DOUBLEBASS_PZL_WSG, .slv = FF_DOUBLEBASS_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "drum", .pzl = FF_DRUM_PZL_WSG, .slv = FF_DRUM_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "meteor", .pzl = FF_METEOR_PZL_WSG, .slv = FF_METEOR_SLV_WSG, .marqueeFact = "We're gonna need a bigger Holy."},
    {.name = "pslogo", .pzl = FF_PSLOGO_PZL_WSG, .slv = FF_PSLOGO_SLV_WSG, .marqueeFact = "You are now hearing the PS1 start-up jingle in your head."},
    {.name = "sax", .pzl = FF_SAX_PZL_WSG, .slv = FF_SAX_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
    {.name = "sfclogo", .pzl = FF_SFCLOGO_PZL_WSG, .slv = FF_SFCLOGO_SLV_WSG, .marqueeFact = "YOU ARE A SUPER PLAYER!!"},
    {.name = "tank", .pzl = FF_TANK_PZL_WSG, .slv = FF_TANK_SLV_WSG, .marqueeFact = "UTE! UTE! UTE! UTE! UTE!"},
    {.name = "trumpet", .pzl = FF_TRUMPET_PZL_WSG, .slv = FF_TRUMPET_SLV_WSG, .marqueeFact = "doot doot"},
    {.name = "wing", .pzl = FF_WING_PZL_WSG, .slv = FF_WING_SLV_WSG, .marqueeFact = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"},
};
