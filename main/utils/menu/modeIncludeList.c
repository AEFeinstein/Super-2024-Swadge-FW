...
swadgeMode_t* const allSwadgeModes[] = {
    ...
    &factoryTestMode, &gamepadMode,    &gottaGoMode,      &introMode,          &jukeboxMode,
    &keebTestMode,    &mainMenuMode,   &modeCh32v003test, &modeCredits,        &nameTestMode,
    &rayMode,         &roboRunnerMode, &sonaTestMode,     &swadgePassTestMode, &swsnCreatorMode,
