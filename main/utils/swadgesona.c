...
static const cnfsFileIdx_t hatWsgs[] = {
    ...
    HA_CHEF_WSG,     HA_COOL_HAT_WSG,       HA_COWBOY_WSG,         HA_DEVIL_WSG,           HA_GARBOTNIK_WSG,
    HA_GRAD_CAP_WSG, HA_HEART_WSG,          HA_HOMESTUCK_WSG,      HA_KINETIC_DONUT_WSG,   HA_MET_HELMET_WSG,
    HA_MILLIE_WSG,   HA_MINI_HOMESTUCK_WSG, HA_MOXXIE_WSG,         HA_PUFFBALL_BEANIE_WSG, HA_PULSE_WSG,
    HA_SANS_WSG,     HA_SAWTOOTH_WSG,       HA_TALL_HOMESTUCK_WSG, HA_TINY_HOMESTUCK_WSG,  HA_TENNA_WSG,
    HA_TRON_WSG,     HA_TV_HEAD_WSG,        HA_VEROSIKA_WSG,       HA_WIDE_HOMESTUCK_WSG,
};
