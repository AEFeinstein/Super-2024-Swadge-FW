...
bool textEntryDraw(void)
{
    ...
    switch(keyMod)
    {
        case SHIFT:
        {
            ...
            drawText( textEntryIBM, WHITE, "Typing: Upper", (TFT_WIDTH - width)/2, TFT_HEIGHT - textEntryIBM->height - 2);
            drawLineFast( (TFT_WIDTH - width)/2 + typingWidth, TFT_HEIGHT - 1, (TFT_WIDTH - width)/2 + width, TFT_HEIGHT - 1, WHITE );
            break;
        }
        case NO_SHIFT:
        {
            int16_t width = textWidth(textEntryIBM, "Typing: Lower");
            drawText( textEntryIBM, WHITE,  "Typing: Lower", (TFT_WIDTH - width)/2, TFT_HEIGHT - textEntryIBM->height - 2);
            break;
        }
        case CAPS_LOCK:
        {
            ...
            int16_t typingWidth = textWidth(textEntryIBM, "Typing: ");
            drawText( textEntryIBM, WHITE, "Typing: CAPS LOCK", (TFT_WIDTH - width)/2, TFT_HEIGHT - textEntryIBM->height - 2 );
            drawLineFast( (TFT_WIDTH - width)/2 + typingWidth, TFT_HEIGHT - 1, (TFT_WIDTH - width)/2 + width, TFT_HEIGHT - 1, WHITE );
            break;
        }
        default:
